...
export class ProductCategoryService {
  ...
  private readonly apiUrl = hairLabApi('product-category');

  getAll(): Observable<ProductCategory[]> {
    return this.http.get<ProductCategory[]>(this.apiUrl);
  }

  getActive(): Observable<ProductCategory[]> {
  ...
  activate(id: number): Observable<ProductCategory> {
    return this.http.patch<ProductCategory>(`${this.apiUrl}/${id}/activate`, {});
  }
}